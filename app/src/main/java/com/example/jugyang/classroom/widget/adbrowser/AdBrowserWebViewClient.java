 ...
 * File Name:        AdBrowserWebViewClient
 * Description:      Created by jugyang on 4/23/17.
 * Function:         Custom WebViewClient for AdBrowserWebView which handles different url schemes.
...
public class AdBrowserWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        MyLog.i("shouldOverrideUrlLoading url=" + url);
